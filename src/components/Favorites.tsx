...
const Favorites: React.FC = () => {
    ...
    return (
        favoriteLocations.length > 0 ? (
            ...
            <div className='w-full flex-1 flex flex-col items-center justify-center overflow-y-auto dark:bg-blue-950 dark:text-gray-50'>
                <h1>No favorite locations added!</h1>
